  ...
  return (
    <div className="space-y-2">
      {models.map((model) => {
        ...
        const preset = PROVIDER_PRESETS[model.providerType];
        ...
        return (
          ...
          >
            ...
            >
              ...
              <span className={`px-2 py-0.5 rounded text-xs font-medium ${getProviderColor(model.providerType)}`}>
                {preset?.label || model.providerType}
              </span>
            </button>
