...
- **다양한 AI 제공자**: Gemini API, OpenRouter, Antigravity Proxy 중 선택
...
| Antigravity Proxy | Google OAuth | API 키 불필요, 로컬 프록시 사용 |
...
2. **제공자 선택**: 하나의 제공자 선택 (Gemini, OpenRouter, 또는 Antigravity)
